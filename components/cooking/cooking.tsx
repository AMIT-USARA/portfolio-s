...
const Cooking = () => {
  return (
    <main>
                ...
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    <p className="inline-flex gap-2 text-base">
                      ...
                      >
                        codechef: 
                        <span className="whitespace-pre-wrap text-8xl font-medium tracking-tighter text-black dark:text-white block">
      ...
      <div className="mb-5">
        <h1>tools 🧰</h1>
        {/* ⭕ Postgres ⭕ Prisma ⭕ Docker ⭕ Redis ⭕ CI/CD ⭕ AWS */}
        <VelocityScroll
          text="Typescript ⭕ React ⭕ Next.js ⭕ Tailwind CSS ⭕ Vercel ⭕ Node ⭕ Express ⭕ MongoDB  ⭕ Github ⭕ Socket.io ⭕"
          default_velocity={5}
