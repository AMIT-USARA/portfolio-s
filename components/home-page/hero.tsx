  ...
  return (
                ...
                <div>
                  <AlertDialogHeader>
                    ...
                    <span className="text-xs text-slate-400">
                      -3rd yr student at IIIT-Bhagalpur
                    </span>
    ...
    />
        ...
        <div className="flex gap-2 cursor-pointer">
          <a
            href="/resume-amit.pdf" // Path to the resume file (could be in public folder)
            download="amit_resume.pdf" // Custom filename for the downloaded file
          ...
          <a
            href="https://www.linkedin.com/in/usara-amit023/"
            target="_blank"
          ...
          <a
            href="https://github.com/AMIT-USARA"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Github size={20} />
